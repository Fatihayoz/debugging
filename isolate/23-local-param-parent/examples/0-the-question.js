...
const arg1 = 5;
const returned1 = findTheType(arg1); // typeof return string
console.log(typeof returned1, returned1);
// console.log(typeof param, param); // param is not defined outside the function
// console.log(typeof result, result); // result is not defined outside the function
