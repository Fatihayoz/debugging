...
* @param {string} param1 - becomes the second string in the result
* @param {string} param2 - becomes the third string in the result
* @param {string} param3 - becomes the first string in the result
